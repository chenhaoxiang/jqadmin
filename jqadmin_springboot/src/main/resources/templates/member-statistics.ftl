            ...
            <div class="col-xs-6 col-sm-4 col-md-2">
                <section class="panel">
                    ...
                    <div class="value tab-menu">
                          <a href="javascript:;" data-url="/user-info" data-parent="true" data-title="会员总数"> <i class="iconfont " data-icon='&#xe6bc;'></i>
                            <h1>10</h1>
                        </a>
                        <p>会员总数</p>
                    </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-2">
                <section class="panel">
                    <div class="symbol bgcolor-dark-green"> <i class="iconfont">&#xe6bc;</i>
                     ...
                     <div class="value tab-menu">
                          <a href="javascript:;" data-url="/user-info" data-parent="true" data-title="男性会员"> <i class="iconfont " data-icon='&#xe6bc;'></i>
                            <h1>10</h1>
                        </a>
                        <p>男性会员</p>
                    </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-2">
                <section class="panel">
                    <div class="symbol bgcolor-yellow-green"> <i class="iconfont">&#xe649;</i>
                         ...
                         <div class="value tab-menu">
                          <a href="javascript:;" data-url="/user-info" data-parent="true" data-title="女性会员"> <i class="iconfont " data-icon='&#xe6bc;'></i>
                            <h1>10</h1>
                        </a>
                        <p>女性会员</p>
                    </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-2">
                <section class="panel">
                    <div class="symbol bgcolor-orange"> <i class="iconfont">&#xe638;</i>
                     ...
                     <div class="value tab-menu">
                          <a href="javascript:;" data-url="/user-info" data-parent="true" data-title="活跃会员"> <i class="iconfont " data-icon='&#xe6bc;'></i>
                            <h1>10</h1>
                        </a>
                        <p>活跃会员</p>
                    </div>
